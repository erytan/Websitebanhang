...
class ProductService{
    ...
    public function getMLSPProduct(){
        $sanpham = $this->dbcollectProduct->distinct('maloaisp');
        return $sanpham;
    }
    public function getNSXProduct(){
        $sanpham = $this->dbcollectProduct->distinct('manhasx');
        return $sanpham;
    }
      // IMAGE  GET
