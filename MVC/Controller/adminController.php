...
if (isset($_GET['controller'])) {
   ...
   if ($controller == "deleteProducerPOST") {
      ...
      if (
         ...
         $re = $_POST['manhasx'];
         $ten = $_POST['tennhasx'];
         $result = $adminc->productService->getNSXProduct();
         if(in_array($ten,$result)){
            $re = $adminc->nhasxService->getAllNhasx();
            include '../view_admin/producer_index.php';
         }else{
   ...
   if ($controller == "deleteLSPPOST") {
      if (!empty($_POST['maloaisp'])){
         $re = $_POST['maloaisp'];
         $ten = $_POST['tenloai'];
         $result = $adminc->productService->getMLSPProduct();
         if(in_array($ten, $result)){
            $re = $adminc->loaispService->getAllLoaiSP();
            include '../view_admin/loaisp_index.php';
         }else
   ...
   if ($controller == "indexGiaoHangPOST") {
      if (
         !empty($_POST['madh'])|| !empty($_POST['manv'])||
         !empty($_POST['ngaygiao'])|| !empty($_POST['tinhtrang'])
      ) {
