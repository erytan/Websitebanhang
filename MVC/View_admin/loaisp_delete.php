                    ...
                    <div class="card">
                        ...
                        <form method="post" action="adminController.php?controller=deleteLSPPOST">
							<div class="card-body">
                                ...
                                <div class="form-group"style="display: none;" >
                                    <label for="exampleInputEmail1" >Mã nhà sản xuất</label> <input type="text" class="form-control" id="tenloai" name="tenloai" value="<?php echo $re['tenloai']; ?>" placeholder="Nhập sản phẩm" >
                                </div>
