                    ...
                    <div class="card">
                        ...
                        <form method="post" action="adminController.php?controller=deleteProducerPOST">
                            <div class="card-body">
                                ...
                                <div class="form-group" style="display: none;">
                                    <label for="exampleInputEmail1">Mã nhà sản xuất</label> <input type="text" class="form-control" id="tennhasx" name="tennhasx" value="<?php echo $re['tennhasx']; ?>" placeholder="Nhập sản phẩm">
                                </div>
